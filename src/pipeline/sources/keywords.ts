...
export const KEYWORDS: string[] = [
  ...
  'rituais de passagem natureza',
  // Spanish
  'baño de bosque',
  'ecoterapia',
  'círculo de duelo climático',
  'conexión con la naturaleza',
  'terapia de bosque comunitaria',
  'ritos de paso naturaleza',
  // French
  'bain de forêt',
  'cercle de deuil climatique',
  'connexion à la nature',
  'thérapie forestière communautaire',
  'rites de passage nature',
  // Dutch
  'bosbaden',
  'ecotherapie',
  'klimaatrouwkring',
  'natuurverbinding',
  'bostherapie gemeenschap',
  // Italian
  'bagno di foresta',
  'ecoterapia',
  'cerchio di lutto climatico',
  'connessione con la natura',
  'terapia forestale comunitaria',
  // Finnish
  'metsäkylpy',
  'luontoterapia',
  'ilmastosurupiiri',
