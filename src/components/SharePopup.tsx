      ...
      >
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            style={{
              background: copied ? 'var(--color-amber-light)' : 'var(--color-pill-bg)',
              border: `0.5px solid ${copied ? 'var(--color-amber-border)' : 'var(--color-pill-bg)'}`,
            }}
          >
            {copied ? (
            ...
            <span
              ...
              style={{ color: copied ? 'var(--color-amber)' : 'var(--color-text-secondary)' }}
            >
          ...
          <button
            ...
            style={{
              ...
              border: '0.5px solid var(--color-pill-bg)',
            }}
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="var(--color-text-secondary)">
          ...
          >
            ...
            <span className="text-[11px] font-medium" style={{ color: 'var(--color-text-secondary)' }}>Telegram</span>
          </button>
        </div>
      </div>
    </div>
