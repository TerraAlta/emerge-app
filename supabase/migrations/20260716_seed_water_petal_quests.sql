...
insert into public.learning_quests (petal_id, title, description, order_index, xp_reward) values
 ('water', 'Water as Teacher',      'Before you move a single drop, learn to watch it.', 0, 50),
 ('water', 'Reading the Landscape', 'Find the invisible lines the water already follows.', 1, 50);
...
from public.learning_quests where petal_id='water' and order_index=0;
...
from public.learning_quests where petal_id='water' and order_index=1;
